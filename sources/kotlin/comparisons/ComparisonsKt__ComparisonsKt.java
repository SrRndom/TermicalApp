...
public class ComparisonsKt__ComparisonsKt {
    ...
    public static final <T> Comparator<T> then(final Comparator<T> receiver, final Comparator<? super T> comparator) {
    ...
    public static final <T> Comparator<T> thenDescending(final Comparator<T> receiver, final Comparator<? super T> comparator) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(comparator, "comparator");
