...
public final class TextStreamsKt {
    ...
    public static final <T> T useLines(Reader receiver, Function1<? super Sequence<String>, ? extends T> block) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    public static final long copyTo(Reader receiver, Writer out, int i) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
