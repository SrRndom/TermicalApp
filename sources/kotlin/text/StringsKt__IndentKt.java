...
public class StringsKt__IndentKt {
    ...
    public static final String replaceIndentByMargin(String receiver, String newIndent, String marginPrefix) {
        ...
        String sb = ((StringBuilder) CollectionsKt.joinTo$default(arrayList, new StringBuilder(length), StringUtils.LF, null, null, 0, null, null, 124, null)).toString();
    ...
    public static final String replaceIndent(String receiver, String newIndent) {
        ...
        String sb = ((StringBuilder) CollectionsKt.joinTo$default(arrayList4, new StringBuilder(length), StringUtils.LF, null, null, 0, null, null, 124, null)).toString();
        Intrinsics.checkExpressionValueIsNotNull(sb, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return sb;
    }
    ...
    public static final String prependIndent(String receiver, final String indent) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        ...
        String sb = ((StringBuilder) CollectionsKt.joinTo$default(arrayList, new StringBuilder(i), StringUtils.LF, null, null, 0, null, null, 124, null)).toString();
        Intrinsics.checkExpressionValueIsNotNull(sb, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return sb;
    }
}
