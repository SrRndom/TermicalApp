...
public final class JvmClassMappingKt {
    ...
    public static final <T> Class<T> getJavaClass(KClass<T> receiver) {
    ...
    public static final <T> Class<T> getJavaPrimitiveType(KClass<T> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) receiver).getJClass();
        if (cls.isPrimitive()) {
            if (cls != null) {
    ...
    public static final <T> Class<T> getJavaObjectType(KClass<T> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) receiver).getJClass();
        if (!cls.isPrimitive()) {
            if (cls != null) {
    ...
    public static final <T> KClass<T> getKotlinClass(Class<T> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    public static final <T> Class<KClass<T>> getRuntimeClassOfKClassInstance(KClass<T> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final <T> boolean isArrayOf(Object[] objArr) {
        Intrinsics.reifiedOperationMarker(4, "T");
        return Object.class.isAssignableFrom(objArr.getClass().getComponentType());
    }

    public static final <T extends Annotation> KClass<? extends T> getAnnotationClass(T receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
