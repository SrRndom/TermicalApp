...
class MapsKt__MapWithDefaultKt {
    ...
    public static final <K, V> Map<K, V> withDefault(Map<K, ? extends V> receiver, Function1<? super K, ? extends V> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(defaultValue, "defaultValue");
        return receiver instanceof MapWithDefault ? MapsKt.withDefault(((MapWithDefault) receiver).getMap(), defaultValue) : new MapWithDefaultImpl(receiver, defaultValue);
    }

    public static final <K, V> Map<K, V> withDefaultMutable(Map<K, V> receiver, Function1<? super K, ? extends V> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(defaultValue, "defaultValue");
        return receiver instanceof MutableMapWithDefault ? MapsKt.withDefaultMutable(((MutableMapWithDefault) receiver).getMap(), defaultValue) : new MutableMapWithDefaultImpl(receiver, defaultValue);
    }
}
