...
public final class SlidingWindowKt {
    ...
    public static final <T> Sequence<List<T>> windowedSequence(final Sequence<? extends T> receiver, final int i, final int i2, final boolean z, final boolean z2) {
    ...
    public static final <T> Iterator<List<T>> windowedIterator(Iterator<? extends T> iterator, int i, int i2, boolean z, boolean z2) {
        ...
        return !iterator.hasNext() ? EmptyIterator.INSTANCE : SequenceBuilderKt.buildIterator(new SlidingWindowKt$windowedIterator$1(i2, i, iterator, z2, z, null));
    }
}
