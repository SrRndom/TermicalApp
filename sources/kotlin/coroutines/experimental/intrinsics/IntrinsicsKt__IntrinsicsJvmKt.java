...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineUnchecked(final Function1<? super Continuation<? super T>, ? extends Object> receiver, final Continuation<? super T> completion) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <R, T> Continuation<Unit> createCoroutineUnchecked(final Function2<? super R, ? super Continuation<? super T>, ? extends Object> receiver, final R r, final Continuation<? super T> completion) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        if (receiver instanceof CoroutineImpl) {
    ...
    public static final Object getCOROUTINE_SUSPENDED() {
        return CoroutineSuspendedMarker.INSTANCE;
    }
}
