...
class MathKt__BigDecimalsKt {
    private static final BigDecimal plus(BigDecimal receiver, BigDecimal bigDecimal) {
    ...
    private static final BigDecimal minus(BigDecimal receiver, BigDecimal bigDecimal) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final BigDecimal times(BigDecimal receiver, BigDecimal bigDecimal) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final BigDecimal div(BigDecimal receiver, BigDecimal bigDecimal) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final BigDecimal mod(BigDecimal receiver, BigDecimal bigDecimal) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final BigDecimal rem(BigDecimal receiver, BigDecimal bigDecimal) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        BigDecimal remainder = receiver.remainder(bigDecimal);
        Intrinsics.checkExpressionValueIsNotNull(remainder, "this.remainder(other)");
        return remainder;
    ...
    private static final BigDecimal unaryMinus(BigDecimal receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final BigDecimal inc(BigDecimal receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    private static final BigDecimal dec(BigDecimal receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
