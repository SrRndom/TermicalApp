...
public final class zzge {
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            SENDKIT(624),
            PEOPLE_AUTOCOMPLETE_CLIENT(FTDISerialDevice.FTDI_BAUDRATE_4800),
            PHOTOS(42),
            GCM(43),
            GOKART(44),
            FINDR(45),
            ...
            PLAY_MUSIC_ANDROID_WEAR_PRIMES(ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case 624:
                        return SENDKIT;
                    case FTDISerialDevice.FTDI_BAUDRATE_4800 /* 625 */:
