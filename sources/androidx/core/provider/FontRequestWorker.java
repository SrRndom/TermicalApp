...
public class FontRequestWorker {
    ...
    private static final ExecutorService DEFAULT_EXECUTOR_SERVICE = RequestExecutor.createDefaultExecutor("fonts-androidx", 10, FTDISerialDevice.FTDI_BAUDRATE_300);
